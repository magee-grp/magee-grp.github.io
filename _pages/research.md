...
In the group, we are interested in how we can best leverage this information to study rates of [viral spread](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1011640), and to examine [the geospatial dispersal patterns](https://academic.oup.com/sysbio/article/73/3/562/7665881) of viruses, particularly from a Bayesian perpective.
...
Phylogenetic models, however, can get rather complex, have to make (often stringent) simplifying assumptions, and the phylogeny itself is often an obstacle to inference.
Thus, we are interested in ways that we can quantify [the effects of our simplifying assumptions](https://academic.oup.com/mbe/article/38/10/4603/6287069) and double check that [our analysis worked](https://doi.org/10.1214/22-ba1339).
